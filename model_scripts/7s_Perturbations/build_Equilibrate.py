...
def main():
    ...
    tEq = str(sys.argv[2])
    Frames =  str(sys.argv[3])
    Nevery = str(sys.argv[4])
    tstep = str(sys.argv[5])
    MakeDist = str(sys.argv[6])
    BreakDist = str(sys.argv[7])
    MakeProb = str(sys.argv[8])
    BreakProb = str(sys.argv[9])
    seed  = str(sys.argv[10])
    tmix = 1e5
...
variable ttotal     equal   $(v_tmix+v_tbonds)		#total timesteps
