...
foldernameadd='run_StretchOnly/runNoRemodAblate_tStr'${Time_Str}'_tRel'${Time_Rel}'_tInitRel'${Time_InitRel}'_DataID'${DataID}'_Xstretch'${XStretch}'_Frames'${NumFrames}'_tstep'${tstep}'_Nev'${Nevery}'_MP'${MP}'_BP'${BP}'_MD'${MD}'_BD'${BD}'_seed'${seed}
mkdir ${foldernameadd}
