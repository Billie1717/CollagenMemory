...
write_restart	restart.postInitRel

variable box_sizeX equal xhi-xlo
variable box_sizeY equal yhi-ylo

#DEDFINING ABLATION REGION\n''')
    fo.write('region OuterCyl cylinder z $(v_box_sizeX/2) $(v_box_sizeY/2) 93 0.0 12.0   #dim c1 c2 radius lo hi\n')
    fo.write('region InnerCyl cylinder z $(v_box_sizeX/2) $(v_box_sizeY/2) 68.55 0.0 12.0   #dim c1 c2 radius lo hi\n')
    fo.write('''
...
group OuterCylAtoms region OuterCyl
group InnerCylAtoms region InnerCyl
group RingAtoms subtract OuterCylAtoms InnerCylAtoms

#delete_atoms region regionbox compress no bond yes 
delete_atoms group RingAtoms compress no bond yes 
reset_atom_ids
