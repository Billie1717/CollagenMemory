...
def main():
    ...
    FracTagged = float(sys.argv[4])
    datadir  = str(sys.argv[1]) +'/GaussianSpreadF'+str(FracTagged)+'/'
    ...
    eligible_indices = [j for j in range(NumCoords) if types[j] > 1] #only choosing type 7s to tag
